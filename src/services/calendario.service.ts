...
//   async createEvento(
//     nucleoId: string,
//     data: Partial<CalendarioEvento>,
//   ): Promise<CalendarioEvento> {
//     const response = await api.post<CalendarioEvento>(
//       API_ROUTES.CALENDARIO.CREATE(nucleoId),
//       data,
//     );
//     return response.data;
//   },
...
//     data: Partial<CalendarioEvento>,
//   ): Promise<CalendarioEvento> {
//     const response = await api.put<CalendarioEvento>(
//       API_ROUTES.CALENDARIO.UPDATE(id),
//       data,
//     );
//     return response.data;
//   },
