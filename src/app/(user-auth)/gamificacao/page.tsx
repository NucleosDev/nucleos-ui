...
// import { ConquistaCard } from "@/src/components/layout-auth/ConquistaCard2";
// import {
//   useUserLevel,
//   useStreaks,
//   useConquistas,
// } from "@/src/hooks/useGamificacao";
// import type { Conquista } from "@/src/types/gamification";

// // ---------------------------------------------------------------------------
// // Skeleton
// // ---------------------------------------------------------------------------
// function ConquistasSkeleton(): JSX.Element {
//   return (
//     <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 md:grid-cols-6">
...
// // Página
// // ---------------------------------------------------------------------------
// export default function GamificacaoPage(): JSX.Element {
//   const router = useRouter();
