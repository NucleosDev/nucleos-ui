  ...
  const features = [
    {
      ...
      description:
        "Crie espaços únicos para cada matéria com temas, cores e configurações próprias.",
    },
    {
      icon: Calendar,
      title: "Cronograma Inteligente",
      description:
        "Sistema de agendamento com repetição espaçada baseado em algoritmos científicos.",
    },
    {
      icon: Brain,
      title: "Revisão Adaptativa",
      description:
        "IA que identifica pontos fracos e ajusta automaticamente seu plano de estudos.",
    },
    {
      icon: LineChart,
      title: "Analytics Avançado",
      description:
        "Métricas detalhadas sobre tempo, foco, retenção e evolução ao longo do tempo.",
    },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
                Crie Nucleos para cada disciplina, acompanhe seu progresso em
                tempo real e transforme o aprendizado em uma experiência
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            ...
            <BentoCard className="md:col-span-2 md:row-span-2 p-8">
              <div className="h-full flex flex-col">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Crie um Nucleo dedicado para cada disciplina. Matemática,
                  Física, Programação, Idiomas - cada área com seu próprio
                  espaço, configurações e progresso independente.
                </p>
            ...
            <BentoCard className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Organize sua rotina de estudos com lembretes automáticos
              </p>
            </BentoCard>
            ...
            <BentoCard className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Algoritmo científico para retenção máxima
              </p>
            </BentoCard>
            ...
            <BentoCard className="md:col-span-2 p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Gráficos e insights sobre seu desempenho
                  </p>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
                Cada matéria é um <span className="text-primary">universo</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Organize suas disciplinas em Nucleos independentes. Cada tarefa
                concluída é XP, cada dia de estudo fortalece seu streak.
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              ...
              gamificação. Comece grátis e desbloqueie seu potencial.
            </p>
