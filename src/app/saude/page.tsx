...
function CircularProgress({ value, max, unit, label, color }: { value: number; max: number; unit: string; label: string; color: string }) {
  ...
  const features = [
    {
      ...
      description: "Acompanhe exercícios, sono, alimentação e hidratação em um só lugar."
    },
    {
      icon: Target,
      title: "Metas Personalizadas",
      description: "Defina objetivos realistas e receba lembretes para manter a consistência."
    },
    {
      icon: Brain,
      title: "Saúde Mental",
      description: "Meditação guiada, exercícios de respiração e registro de humor diário."
    },
    {
      icon: TrendingUp,
      title: "Insights Inteligentes",
      description: "Análises e recomendações baseadas nos seus dados e padrões de comportamento."
    }
  ]
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex items-center gap-2 rounded-full border border-rose-500/20 bg-rose-500/5 px-4 py-2 text-sm backdrop-blur-sm">
                ...
                <Badge variant="secondary" className="bg-rose-500/10 text-rose-500 hover:bg-rose-500/20 text-xs">
                  Popular
                </Badge>
              </div>
            </div>
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
                Acompanhe exercícios, alimentação, sono e bem-estar em uma jornada gamificada. 
                Construa hábitos saudáveis e celebre cada conquista.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">89%</p>
                  <p className="text-sm text-muted-foreground">Mantêm hábitos</p>
                </div>
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">3.2x</p>
                  <p className="text-sm text-muted-foreground">Mais motivação</p>
                </div>
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                ...
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">30d</p>
      ...
      <section className="py-20 md:py-32 relative">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <Badge variant="outline" className="mb-4">Dashboard Diário</Badge>
            <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
              Tudo em um só{" "}
              <span className="text-primary">lugar</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              Visualize seu progresso diário e mantenha o foco nas suas metas de saúde.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            ...
            <BentoCard className="md:col-span-2 md:row-span-2 p-8">
              <div className="h-full flex flex-col">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-foreground">Progresso do Dia</h3>
                    <p className="text-muted-foreground">Quarta-feira, 20 de março</p>
                  </div>
                  <div className="flex items-center gap-1.5 rounded-full bg-orange-500/10 px-3 py-1.5">
                    <Flame className="h-4 w-4 text-orange-500" />
                    <span className="text-sm font-medium text-orange-500">15 dias</span>
                  </div>
                </div>
                
                {/* Progress Circles */}
                <div className="flex-1 flex items-center justify-around py-8">
                  <CircularProgress value={8500} max={10000} unit="passos" label="Passos" color="text-blue-500" />
                  <CircularProgress value={6} max={8} unit="copos" label="Água" color="text-cyan-500" />
                  <CircularProgress value={7.5} max={8} unit="horas" label="Sono" color="text-purple-500" />
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 mt-auto">
                  ...
                  <div className="rounded-xl bg-amber-500/10 p-3 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">kcal ingeridas</p>
                  </div>
                </div>
              </div>
            </BentoCard>
            ...
            <BentoCard className="p-6 bg-gradient-to-br from-emerald-500/10 to-transparent border-emerald-500/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded-full">+150 XP</span>
              </div>
            ...
            <BentoCard className="p-6 bg-gradient-to-br from-purple-500/10 to-transparent border-purple-500/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-purple-500 bg-purple-500/10 px-2 py-0.5 rounded-full">Ótimo</span>
              </div>
            ...
            <BentoCard className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Acompanhe macros e calorias com registro simplificado</p>
            </BentoCard>
            ...
            <BentoCard className="p-6">
              ...
              <p className="text-sm text-muted-foreground">Lembretes para manter a ingestão de água ideal</p>
            </BentoCard>
            ...
            <BentoCard className="md:col-span-2 p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="font-semibold text-foreground mb-1">Progresso Semanal</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Monitore todos os aspectos da sua saúde física e mental. Cada meta atingida é XP, 
                cada hábito mantido fortalece seu streak. Cuide-se de forma divertida.
              </p>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">30 dias de exercício</p>
            ...
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">7 dias bebendo 2L</p>
              <div className="mt-3 flex justify-center">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
            ...
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">14 noites de 8h</p>
              <div className="mt-3 flex justify-center">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
            ...
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">21 dias de dieta</p>
              <div className="mt-3 flex justify-center">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              Junte-se a milhares de pessoas que estão transformando seus hábitos. 
              Comece grátis e evolua sua saúde de forma gamificada.
            </p>
