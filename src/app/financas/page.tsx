  ...
  const features = [
    {
      ...
      description: "Sincronize com bancos e categorize gastos automaticamente com IA."
    },
    {
      icon: Target,
      title: "Metas Inteligentes",
      description: "Defina objetivos financeiros e receba planos personalizados para atingi-los."
    },
    {
      icon: LineChart,
      title: "Analytics Avançado",
      description: "Relatórios detalhados e previsões baseadas no seu comportamento financeiro."
    },
    {
      icon: Shield,
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/5 px-4 py-2 text-sm backdrop-blur-sm">
                ...
                <span className="text-foreground font-medium">Para Finanças</span>
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
                Organize gastos, economize mais, invista melhor. Transforme sua relação com 
                o dinheiro em uma jornada gamificada rumo à liberdade financeira.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">63%</p>
                  <p className="text-sm text-muted-foreground">Atingem metas</p>
                </div>
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">R$2.4k</p>
                  <p className="text-sm text-muted-foreground">Economia média</p>
                </div>
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">8K+</p>
                  <p className="text-sm text-muted-foreground">Usuários ativos</p>
                </div>
                <div className="text-center p-4 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30">
                  <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">4.9</p>
      ...
      <section className="py-20 md:py-32 relative">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <Badge variant="outline" className="mb-4">Dashboard Financeiro</Badge>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            ...
            <BentoCard className="md:col-span-2 p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <h3 className="text-4xl font-bold text-foreground">R$ 24.850,00</h3>
                </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-xl bg-blue-500/10 p-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-muted-foreground">Conta Principal</span>
                  </div>
            ...
            <BentoCard className="p-6 bg-gradient-to-br from-emerald-500/10 to-transparent border-emerald-500/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded-full">+8%</span>
              </div>
            ...
            <BentoCard className="p-6 bg-gradient-to-br from-rose-500/10 to-transparent border-rose-500/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-rose-500 bg-rose-500/10 px-2 py-0.5 rounded-full">-3%</span>
              </div>
            ...
            <BentoCard className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-3">Economizar R$ 2.000</p>
            ...
            <BentoCard className="md:col-span-2 p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="font-semibold text-foreground mb-1">Fluxo Mensal</h3>
                  <p className="text-sm text-muted-foreground">Comparativo receitas x despesas</p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Organize todas as suas finanças em um só lugar. Cada meta atingida é XP, 
                cada economia é uma conquista. Gamifique seu caminho para a liberdade financeira.
              </p>
      ...
      <section className="py-20 md:py-32 relative">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
              Conquistas{" "}
              <span className="text-primary">financeiras</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              Desbloqueie conquistas por bons hábitos financeiros e metas atingidas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">Primeiro R$1.000</p>
            ...
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">10 metas atingidas</p>
              <div className="mt-3 flex justify-center">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
            ...
            <BentoCard className="p-6 text-center group">
              ...
              <p className="text-xs text-muted-foreground mt-1">Primeiro investimento</p>
              <div className="mt-3 flex justify-center">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              Junte-se a milhares de pessoas que estão conquistando a liberdade financeira. 
              Comece grátis e transforme sua relação com o dinheiro.
            </p>
