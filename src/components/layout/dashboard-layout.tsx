...
const navItems: NavItem[] = [
  ...
  { label: 'Núcleos', href: ROUTES.NUCLEOS, icon: LayoutGrid },
...
const adminNavItems: NavItem[] = [
  ...
  { label: 'Usuários', href: ROUTES.ADMIN_USERS, icon: Users, roles: ['admin'] },
  { label: 'Núcleos Admin', href: ROUTES.ADMIN_NUCLEOS, icon: LayoutGrid, roles: ['admin'] },
]
...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const filteredNavItems = navItems.filter(item => 
    !item.roles || item.roles.some(role => hasPermission(role))
  )
