  ...
  return (
    <section className="relative  overflow-hidden px-4 min-h-screen sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-6xl relative z-20">
        ...
        <h2 data-animate="fade-up" data-delay="100" className="text-balance text-center text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">
          O{" "}
        ...
        <p data-animate="fade-up" data-delay="200" className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
