...
export function Header() {
  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-0">
            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                ...
                <NavigationMenuContent className="bg-background p-1 pr-1.5">
                  <ul className="grid w-lg grid-cols-2 gap-2 rounded-md border p-2 shadow">
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent className="bg-background p-1 pr-1.5 pb-1.5">
                  <div className="grid w-lg grid-cols-2 gap-2">
                    <ul className=" space-y-2 rounded-md border p-2 shadow">
                    ...
                    <ul className="space-y-2 p-3">
                      {companyLinks2.map((item, i) => (
                        <li key={i}>
                          <NavigationMenuLink
                            href={item.href}
                            className="flex p-2 hover: flex-row rounded-md items-center gap-x-2"
                          >
              ...
              <NavigationMenuLink className="px-4" asChild>
                <a href="#" className="hover:rounded-md p-2">
                  Pricing
                </a>
              </NavigationMenuLink>
            </NavigationMenuList>
...
function ListItem({
  ...
  return (
    <NavigationMenuLink
      className={cn(
        "w-full flex flex-row gap-x-2 data-[active=true]:focus: data-[active=true]:hover: data-[active=true]: data-[active=true]:text-accent-foreground hover: hover:text-accent-foreground focus: focus:text-accent-foreground rounded-sm p-2",
        className,
      )}
      {...props}
      asChild
